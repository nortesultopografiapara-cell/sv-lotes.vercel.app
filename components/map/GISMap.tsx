      ...
      <div className="space-y-2 mb-4 text-sm">
        ...
        <div className="border-b pb-2 mb-1 mt-1">
           ...
           <div className="grid grid-cols-2 gap-x-4 gap-y-1 bg-gray-50 p-2 rounded w-full border border-gray-100">
             <div className="flex justify-between items-center"><span className="text-gray-500 text-[10px]">Frente:</span> <span className="text-gray-900 text-[11px] font-medium w-16 text-right">{lot.frente !== null && lot.frente !== undefined ? (typeof lot.frente === 'string' ? lot.frente : `${Number(lot.frente).toFixed(2)} m`) : '--'}</span></div>
             <div className="flex justify-between items-center"><span className="text-gray-500 text-[10px]">Fundo:</span> <span className="text-gray-900 text-[11px] font-medium w-16 text-right">{lot.fundo !== null && lot.fundo !== undefined ? (typeof lot.fundo === 'string' ? lot.fundo : `${Number(lot.fundo).toFixed(2)} m`) : '--'}</span></div>
             <div className="flex justify-between items-center"><span className="text-gray-500 text-[10px]">Lado Dir:</span> <span className="text-gray-900 text-[11px] font-medium w-16 text-right">{lot.lado_direito !== null && lot.lado_direito !== undefined ? (typeof lot.lado_direito === 'string' ? lot.lado_direito : `${Number(lot.lado_direito).toFixed(2)} m`) : '--'}</span></div>
             <div className="flex justify-between items-center"><span className="text-gray-500 text-[10px]">Lado Esq:</span> <span className="text-gray-900 text-[11px] font-medium w-16 text-right">{lot.lado_esquerdo !== null && lot.lado_esquerdo !== undefined ? (typeof lot.lado_esquerdo === 'string' ? lot.lado_esquerdo : `${Number(lot.lado_esquerdo).toFixed(2)} m`) : '--'}</span></div>
           </div>
        </div>
