        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className={`flex-1 px-4 py-2 text-white font-semibold rounded-lg transition-colors text-sm flex items-center justify-center gap-2 ${actionName === "Reservado" ? "bg-yellow-500 hover:bg-yellow-600" : "bg-red-600 hover:bg-red-700"}`}
            >
              {submitting ? (
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 text-[11px] font-medium w-16 text-right">
                {lot.frente !== null && lot.frente !== undefined
                  ? typeof lot.frente === "string" && lot.frente.includes("m")
                    ? lot.frente
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 text-[11px] font-medium w-16 text-right">
                {lot.fundo !== null && lot.fundo !== undefined
                  ? typeof lot.fundo === "string" && lot.fundo.includes("m")
                    ? lot.fundo
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 text-[11px] font-medium w-16 text-right">
                {lot.lado_direito !== null && lot.lado_direito !== undefined
                  ? typeof lot.lado_direito === "string" &&
                    lot.lado_direito.includes("m")
                    ? lot.lado_direito
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 text-[11px] font-medium w-16 text-right">
                {lot.lado_esquerdo !== null && lot.lado_esquerdo !== undefined
                  ? typeof lot.lado_esquerdo === "string" &&
                    lot.lado_esquerdo.includes("m")
                    ? lot.lado_esquerdo
          ...
          const parsedBlocks = blocksRes.data
            .map((b) => {
              ...
              return {
                ...
                area:
                  b.area_oficial !== null && b.area_oficial !== undefined
                    ? Number(b.area_oficial)
                    : b.area !== null && b.area !== undefined
                      ? Number(b.area)
                      : 0,
                price:
                ...
                bounds,
                frente:
                  b.frente_oficial !== null && b.frente_oficial !== undefined
                    ? b.frente_oficial
                    : b.frente || null,
                fundo:
                  b.fundo_oficial !== null && b.fundo_oficial !== undefined
                    ? b.fundo_oficial
                    : b.fundo || null,
                lado_direito:
                  b.dir_oficial !== null && b.dir_oficial !== undefined
                    ? b.dir_oficial
                    : b.lado_direito || null,
                lado_esquerdo:
                  b.esq_oficial !== null && b.esq_oficial !== undefined
                    ? b.esq_oficial
                    : b.lado_esquerdo || null,
              };
            })
      ...
      if (newStatus === "Vendido") {
        ...
        try {
          ...
          const { generateContractText } =
            await import("@/lib/contractGenerator");
