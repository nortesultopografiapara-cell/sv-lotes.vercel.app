...
export function GisProjectHeaderBadge() {
  ...
  return (
    <div
      className="inline-flex items-center gap-1.5 h-10 max-w-[88px] sm:max-w-[200px] md:max-w-[280px] lg:max-w-[360px] px-3 rounded-lg border font-semibold text-[var(--text-primary)] text-sm shrink-0 bg-[var(--bg-card-alt)] border-[var(--border-color)]"
      title={project.name}
    >
