    ...
    <>
      <button
        ...
        className={`w-full aspect-square flex items-center justify-center rounded-md transition-colors group relative ${
          open
            ? 'bg-[#4999e9]/20 text-[#4999e9]'
            : 'bg-transparent hover:bg-gray-800 text-gray-400 hover:text-[#4999e9]'
        }`}
      ...
      {open && (
        <div className="absolute top-0 right-full mr-2 w-[min(100vw-5rem,300px)] max-h-[min(70vh,420px)] flex flex-col bg-[#11141a]/98 backdrop-blur-md border border-[#2d3340] rounded-lg shadow-2xl overflow-hidden">
          <div className="flex items-center justify-between gap-2 px-3 py-2.5 border-b border-[#2d3340] shrink-0">
            ...
            <button
              type="button"
              onClick={onToggleOpen}
              className="p-1 rounded text-gray-500 hover:text-white hover:bg-[#2d3340] transition-colors"
            ...
            {loading ? (
              ...
              quadras.map((blockName) => {
                ...
                return (
                  <div
                    key={blockName}
                    className="rounded-md border border-[#2d3340] bg-[#0d1016] p-2.5"
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className="flex items-center gap-2 w-full px-2 py-1.5 rounded text-[11px] font-medium text-gray-300 hover:bg-[#2d3340] hover:text-white transition-colors disabled:opacity-50"
                      >
