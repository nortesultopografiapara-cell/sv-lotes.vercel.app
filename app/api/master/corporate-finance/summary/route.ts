  ...
  try {
    ...
    return NextResponse.json({
      kpis: {
        ...
        receivableDueThisMonth: receivables.dueThisMonth,
        receivableReceivedThisMonth: receivables.receivedThisMonth,
        receivableOpenCount: receivables.openCount,
        receivablePartialCount: receivables.partialCount,
        receivableReceivedCount: receivables.receivedCount,
        payableOpen: payables.totalOpen,
        payableOverdue: payables.overdue,
        payableDueThisMonth: payables.dueThisMonth,
        payablePaidThisMonth: payables.paidThisMonth,
        payableOpenCount: payables.openCount,
        payablePartialCount: payables.partialCount,
