    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-[var(--color-background)]">
      ...
      <div className="hidden md:flex justify-end mb-6">
         <div className="flex items-center gap-3">
           <div className="flex items-center gap-2 text-xs font-mono text-gray-300 bg-[#151a23] py-2 px-4 rounded-xl border border-[var(--color-border)]">
              <Calendar className="w-4 h-4 text-[var(--color-text-muted)]" />
              21/05/2026 - 21/05/2026
           </div>
           <button className="flex items-center gap-2 text-xs font-semibold text-gray-300 bg-[#151a23] hover:bg-[var(--color-surface)] transition-colors py-2 px-4 rounded-xl border border-[var(--color-border)]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-4">
        {/* Total Empresas */}
        <div className="bg-[#151a23] border border-[var(--color-border)] p-5 rounded-2xl relative overflow-hidden group shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
               <p className="text-[13px] text-[var(--color-text-muted)] font-medium">Total de Empresas</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-5 rounded-2xl relative overflow-hidden group shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
               <p className="text-[13px] text-[var(--color-text-muted)] font-medium">Empresas Ativas</p>
        ...
        <div className="bg-[#151a23] border border-orange-500/20 p-5 rounded-2xl relative overflow-hidden group shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
               <p className="text-[13px] text-[var(--color-text-muted)] font-medium">Empresas Suspensas</p>
            ...
            <div className="mt-2">
               ...
               <p className="text-[11px] font-medium text-[var(--color-primary)] mt-1">14.3% do total</p>
            </div>
        </div>
        ...
        <div className="bg-[#151a23] border border-red-500/20 p-5 rounded-2xl relative overflow-hidden group shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
               <p className="text-[13px] text-[var(--color-text-muted)] font-medium">Empresas Inativas</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-5 rounded-2xl relative overflow-hidden group shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
               <p className="text-[13px] text-[var(--color-text-muted)] font-medium">Receita Mensal (MRR)</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        <div className="bg-[#151a23] border border-[var(--color-border)] p-4 rounded-xl flex items-center justify-between">
            <div>
               <p className="text-[12px] text-[var(--color-text-muted)] mb-1 font-medium">Total de Usuários</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-4 rounded-xl flex items-center justify-between">
            <div>
               <p className="text-[12px] text-[var(--color-text-muted)] mb-1 font-medium">Total de Corretores</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-4 rounded-xl flex items-center justify-between">
            <div>
               <p className="text-[12px] text-[var(--color-text-muted)] mb-1 font-medium">Total de Empreendimentos</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-4 rounded-xl flex items-center justify-between">
            <div>
               <p className="text-[12px] text-[var(--color-text-muted)] mb-1 font-medium">Total de Contratos</p>
        ...
        <div className="bg-[#151a23] border border-[var(--color-border)] p-4 rounded-xl flex items-center justify-between">
            <div>
               <p className="text-[12px] text-[var(--color-text-muted)] mb-1 font-medium">Lotes Cadastrados</p>
               <p className="text-xl font-bold text-gray-200">{stats.totalLots}</p>
            </div>
            <Crosshair className="w-6 h-6 text-[var(--color-primary)]/50" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
         {/* Line Chart */}
         <div className="bg-[#151a23] border border-[var(--color-border)] p-6 rounded-2xl shadow-lg">
            <div className="flex justify-between items-center mb-6">
               <h3 className="text-[15px] font-semibold text-gray-200">Receita dos Últimos 6 Meses</h3>
               <select className="bg-[var(--color-surface)] border border-[var(--color-border)] text-[var(--color-text-muted)] text-xs py-1 px-2 rounded-lg outline-none">
            ...
            <div className="h-64 w-full relative">
               ...
               <div className="absolute inset-0 flex items-center justify-center bg-[#151a23]/60 backdrop-blur-sm text-[var(--color-text-muted)] font-medium rounded-lg">
         ...
         {/* Donut Chart */}
         <div className="bg-[#151a23] border border-[var(--color-border)] p-6 rounded-2xl shadow-lg flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-between gap-4">
                <div className="relative w-40 h-40 shrink-0">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                     ...
                     <span className="text-[10px] text-[var(--color-text-muted)] uppercase tracking-widest">Total</span>
                  </div>
                </div>
                <div className="flex flex-col gap-4">
                   {planDistribution.map((plan, i) => (
                     <div key={i} className="flex flex-col">
                       ...
                       <span className="text-xs text-[var(--color-text-muted)] ml-5">{plan.value} empresas {stats.totalCompanies > 0 && `(${(plan.value / stats.totalCompanies * 100).toFixed(1)}%)`}</span>
                     </div>
                   ))}
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-5 overflow-y-auto">
               {alerts.length === 0 ? (
                  <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                     <CheckCircle className="w-10 h-10 text-[var(--color-text-muted)] mb-2" />
                     <p className="text-[var(--color-text-muted)] text-sm font-medium">Nenhum alerta no momento.</p>
                  </div>
               ) : (
                  alerts.map(a => (
                   <div key={a.id} className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                         ...
                         <p className="text-[11px] text-[var(--color-text-muted)] mt-1">{a.desc}</p>
                      </div>
                      <span className="text-[11px] text-[var(--color-text-muted)] shrink-0">{a.time}</span>
                   </div>
                  ))
               )}
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 mb-8">
         {/* Table */}
         <div className="xl:col-span-3 bg-[#151a23] border border-[var(--color-border)] rounded-2xl shadow-lg flex flex-col overflow-hidden">
            ...
            <div className="overflow-x-auto">
               <table className="w-full text-left border-collapse">
                  <thead>
                     <tr className="border-b border-[var(--color-border)] text-[10px] font-bold text-[var(--color-text-muted)] tracking-wider uppercase">
                  ...
                  <tbody className="text-sm">
                     {recentCompanies.length === 0 ? (
                        <tr>
                           <td colSpan={8} className="p-8 text-center text-[var(--color-text-muted)] font-medium">Nenhuma empresa cadastrada.</td>
                        </tr>
                     ) : (
                      recentCompanies.map((c) => (
                         <tr key={c.id} className="border-b border-[var(--color-border)]/50 hover:bg-[var(--color-surface)] transition-colors group">
                           <td className="p-4 pl-6">
                              <div className="flex items-center gap-3">
                                 <div className="w-8 h-8 rounded-lg bg-gray-800 text-gray-300 flex items-center justify-center font-bold text-xs border border-[var(--color-border)]">
                                   {c.name.charAt(0)}
                                 </div>
                                 <div className="flex flex-col">
                                    <span className="font-semibold text-gray-200 text-[13px]">{c.name}</span>
                                    <span className="text-[11px] text-[var(--color-text-muted)]">{c.slug}</span>
                                 </div>
                              </div>
                           </td>
                           <td className="p-4">
                           ...
                           <td className="p-4 pr-6 text-right space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button className="p-1.5 text-[var(--color-text-muted)] hover:text-white hover:bg-gray-800 rounded transition-colors" title="Visualizar">
                                <Eye className="w-4 h-4" />
                              </button>
                              <button className="p-1.5 text-[var(--color-text-muted)] hover:text-white hover:bg-gray-800 rounded transition-colors" title="Editar">
                                <Edit2 className="w-4 h-4" />
                              </button>
                              <button className="p-1.5 text-[var(--color-text-muted)] hover:text-white hover:bg-gray-800 rounded transition-colors" title="Mais Opções">
         ...
         <div className="bg-transparent flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
               <Link href="/companies" className="bg-[#151a23] border border-[var(--color-border)] hover:border-blue-500/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
               ...
               <button onClick={handleMissingFeature} className="bg-[#151a23] border border-[var(--color-border)] hover:border-purple-500/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
               ...
               <button onClick={handleMissingFeature} className="bg-[#151a23] border border-[var(--color-border)] hover:border-green-500/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
               ...
               <button onClick={handleMissingFeature} className="bg-[#151a23] border border-[var(--color-border)] hover:border-yellow-500/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
               ...
               <button onClick={handleMissingFeature} className="bg-[#151a23] border border-[var(--color-border)] hover:border-blue-500/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
               ...
               <Link href="/settings/global" className="bg-[#151a23] border border-[var(--color-border)] hover:border-gray-400/50 hover:bg-[#1a2130] transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group text-center shadow-sm">
                  <div className="p-3 rounded-full bg-gray-500/10 text-[var(--color-text-muted)] group-hover:scale-110 transition-transform">
      ...
      <footer className="mt-8 pt-6 border-t border-[var(--color-border)] flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[var(--color-text-muted)]">
         <div>
            <span className="font-semibold text-[var(--color-text-muted)]">© 2026 SV_LOTES</span> - Plataforma SaaS Imobiliária | Todos os direitos reservados
         </div>
         <div className="flex items-center gap-2">
