...
-- Snapshot histórico permanece em sales.sale_spouse_* (não alterado por este cadastro).
...
CREATE TABLE IF NOT EXISTS public.customer_spouses (
  ...
  CONSTRAINT customer_spouses_cpf_digits_len CHECK (char_length(cpf_digits) = 11)
);
