-- Reparo idempotente do schema SaaS (company_contracts + assinatura bilateral).
-- Corrige produção onde a tabela foi criada sem colunas de regeneração/versionamento.
...
-- Assinatura bilateral (cliente primeiro, SV depois)
