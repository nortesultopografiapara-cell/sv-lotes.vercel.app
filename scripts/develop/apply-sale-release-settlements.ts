/**
 * Aplica a migration aditiva de sale_release_settlements SOMENTE no DEVELOP.
 * npx tsx scripts/develop/apply-sale-release-settlements.ts
 */
...
const MIGRATION = '20261010120000_sale_release_settlements.sql';
  ...
  try {
    ...
    const check = await client.query(`
      ...
      where table_schema = 'public'
        and table_name = 'sale_release_settlements'
