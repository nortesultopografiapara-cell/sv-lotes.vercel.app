...
export const TERMINATION_DOCUMENT_PREFIX_INADIMPLENCIA = 'IN';
/** Termo Aditivo de Troca de Lote — mesma RPC de numeração. Não é termo de encerramento. */
export const LOT_SWAP_DOCUMENT_PREFIX = 'TL';
