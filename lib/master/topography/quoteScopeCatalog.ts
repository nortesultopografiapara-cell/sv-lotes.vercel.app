...
export const technicalResourcesCatalog: readonly QuoteScopeCatalogOption[] = [
  { id: 'tr-dji-matrice-350-rtk', label: 'DJI Matrice 350 RTK', category: 'Drone' },
  { id: 'tr-dji-zenmuse-l2', label: 'DJI Zenmuse L2', category: 'Sensor' },
  { id: 'tr-dji-phantom-4-pro', label: 'DJI Phantom 4 Pro', category: 'Drone' },
  { id: 'tr-gnss-rtk', label: 'Receptor GNSS RTK', category: 'Topografia' },
  { id: 'tr-estacao-total', label: 'Estação Total', category: 'Topografia' },
  { id: 'tr-nivel-digital', label: 'Nível Digital', category: 'Topografia' },
  { id: 'tr-drone-aerofoto', label: 'Drone aerofotogramétrico', category: 'Drone' },
...
export const deliverablesCatalog: readonly QuoteScopeCatalogOption[] = [
  ...
  { id: 'dl-relatorio-proc', label: 'Relatório de processamento', category: 'Documentos' },
  ...
  { id: 'dl-memorial', label: 'Memorial descritivo', category: 'Documentos' },
  { id: 'dl-relatorio-tec', label: 'Relatório técnico', category: 'Documentos' },
  { id: 'dl-dwg', label: 'Arquivo DWG', category: 'Arquivos digitais' },
  { id: 'dl-dxf', label: 'Arquivo DXF', category: 'Arquivos digitais' },
  { id: 'dl-kml', label: 'Arquivo KML', category: 'Arquivos digitais' },
  { id: 'dl-kmz', label: 'Arquivo KMZ', category: 'Arquivos digitais' },
  { id: 'dl-shp', label: 'Shapefile', category: 'Arquivos digitais' },
  { id: 'dl-geojson', label: 'GeoJSON', category: 'Arquivos digitais' },
  { id: 'dl-pdf', label: 'PDF', category: 'Arquivos digitais' },
  { id: 'dl-planilha-coord', label: 'Planilha de coordenadas', category: 'Documentos' },
  { id: 'dl-monografia', label: 'Monografia dos marcos', category: 'Documentos' },
  { id: 'dl-fotos-campo', label: 'Fotografias de campo', category: 'Documentos' },
] as const;
