/** Classes responsivas do container do popup de lote no mapa GIS. */
export const GIS_LOT_POPUP_CONTAINER_CLASS =
  'p-3 md:p-4 w-[min(92vw,360px)] sm:w-[min(92vw,440px)] md:w-[480px] lg:w-[520px] xl:w-[540px] max-w-[min(92vw,540px)] max-h-[min(85vh,640px)] overflow-y-auto bg-white text-gray-900 rounded-md font-sans shadow-xl';
