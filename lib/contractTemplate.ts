...
export function generateContractHTML({
  ...
  return `
        <div style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; line-height: 1.5; color: #111; background: #fff; padding: 10px; text-align: justify;">
            ...
            <div style="text-align: center; margin-top: 10px; margin-bottom: 25px; page-break-inside: avoid;">
                 <h2 style="font-size: 16px; font-weight: bold; text-transform: uppercase; margin: 0; padding: 0;">INSTRUMENTO PARTICULAR DE COMPROMISSO DE COMPRA E VENDA</h2>
            </div>
            ...
            <div style="page-break-inside: avoid; margin-bottom: 20px; padding-bottom: 5px;">
                <p style="margin-bottom: 0;">
