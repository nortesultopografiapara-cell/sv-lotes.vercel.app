...
const ACTION_LABELS: Record<string, string> = {
  ...
  COMPANY_DATA_EXPORT_CREATED: 'Exportação de dados criada',
  COMPANY_DATA_EXPORT_COMPLETED: 'Exportação de dados concluída',
  COMPANY_DATA_EXPORT_FAILED: 'Exportação de dados falhou',
  COMPANY_DATA_EXPORT_CANCELLED: 'Exportação de dados cancelada',
  COMPANY_DATA_EXPORT_DOWNLOAD: 'Download de exportação',
  COMPANY_DATA_EXPORT_FILE_DELETED: 'Arquivo de exportação removido',
  COMPANY_DATA_EXPORT_EXPIRED: 'Exportação expirada',
  COMPANY_DATA_EXPORTED: 'Dados da empresa exportados',
