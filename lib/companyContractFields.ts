...
import {
  ...
  COMPANY_SETTINGS_SECOND_VENDOR_COLUMN,
} from '@/lib/companySettingsFields';

/** Select único para preview, regeneração enxuta e venda GIS → contrato. */
export const COMPANY_CONTRACT_LOAD_SELECT = `${COMPANY_SETTINGS_COLUMNS_BASE}, ${COMPANY_SETTINGS_COLUMNS_EXTENDED}, ${COMPANY_SETTINGS_SECOND_VENDOR_COLUMN}`;
