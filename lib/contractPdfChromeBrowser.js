...
(function () {
  ...
  function applyContractPdfChromeBrowser(pdf, data) {
    ...
    for (var i = 1; i <= totalPages; i++) {
      ...
      var logoW = data.logoWidthMm != null ? data.logoWidthMm : 22;
      var logoH = data.logoHeightMm != null ? data.logoHeightMm : 12;
      ...
      var infoParts = [];
      var docLabel = data.tenantDocumentLabel || 'CNPJ';
      ...
      var logoBottom = data.logoBase64 ? 10 + logoH : 0;
      var finalY = Math.max(yPos, logoBottom, 22) + 2;
