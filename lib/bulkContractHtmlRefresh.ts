/**
 * Regeneração em massa do HTML persistido — mesma lógica do GET legado de /api/regenerate.
 * Não altera templates (ARAGUAIA / PADRAO / MENESES / RECANTO).
 */
...
export async function refreshAllContractGeneratedHtml(
  ...
  if (error) {
    throw new Error('REGENERATE_SELECT_FAILED');
  }
